...
greet(p1); //Person과 구조가 일치하기 때문에 Person취급
greet(p2); //구조적 타이핑에 의해 Person취급(hobby속성을 무시)
// greet(p3); // >> Person의 구조와 일치하지 않음
...
// userA.address.city='전포로'  읽기전용

//! 객체의 인덱스 서명
// :객체의 모든 속성에 대해 타입을 정의 하지 않고
// >> 키와 값의 타입만 정의하여 구조를 우연하게 적용하는 방법
