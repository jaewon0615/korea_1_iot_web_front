...
//while문 조건식 내에 true에 대한 boolean값 사용 시: 무한루프
while(true){
  ...
  const input = prompt('출력할 구구단의 숫자을 입력하세요.(1~9) // exit를 입력하시면 종료됩니다');
  ...
  //-1에서 9사이의 수인 경우 1에서 9를 반복하여 반복한 숫자와 입력된 수를 곱셈하여 출력(if)
  //-숫자로 변환 한 해당 값이 1에서 9사이의 수가 아닌 경우 콘솔창에 안내 메시지 출력(else)
