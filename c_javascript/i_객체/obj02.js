...
// :객체의 메서드로 함수를 호출할 경우 this는 해당 메서드를 호출한 객체에 바인딩(bind:묶다,고정하다)
...
function Person(name){
  //this.name은 person 생성자 함수로 생성되는 각각의 객체를 의미
  //this.name 은 각 객체의 속성
...
arrowObject.showThis(); //전역컨테스트의 this와 동일 - 전역 객체

//! 객체 내부의 this
// 객체 내부에서 현재 쓰이는 객체를 가져오기 위해서 
// this 값 활용 시 일정한 형태의 함수 사용을 권장

// >>선언적 함수,함수 표현식 등 function키워드 사용
