...
function callback2(number,callbackFunc) {   //number는 변수(데이터),callbackFunc 함수
...
callback2(3,print3); //메인 로직에 데이터(number)와 콜백함수(print3)를 전달
callback2(4,print3);