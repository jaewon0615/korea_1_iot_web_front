...
// 2.무작위의 두자리수 데이터를 8개 이상 채움
// 3.passingScores 함수로 60점 이상인 점수의 개수를 passingCount 변수에 저장
...
// 구조분해 할당된 배열안의 각 요소는 개별적인 변수와 동일
...
console.log('==filter사용==');
const oddsNubmers = numbers.filter((value) =>{
  return value % 2 !== 0;
})
console.log(oddsNubmers);
